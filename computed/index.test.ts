...
// проверка, что стор не вычисляется с теми же параметрами
// проверка, что стор не вычисляется с теми же параметрами при изменении других сторов
// проверка, что стор вычисляется при изменении пустого массива на другой пустой массив ???
// проверка передачи функции сравнения для атома
